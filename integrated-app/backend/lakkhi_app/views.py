...
def mercuryo_checkout_url(request):
    ...
    try:
        ...
        try:
            ...
            # Update the project's blockchain if provided
            if blockchain and not project.chain:
                project.chain = blockchain
                project.save()
        except Project.DoesNotExist:
            return JsonResponse({
                "success": False, 
        ...
        checkout_result = PaymentProcessor.get_mercuryo_checkout_url(
            ...
            blockchain=blockchain  # Pass blockchain to payment processor
        )
